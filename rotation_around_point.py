...
def main():
    ...
    while (True):
        ...
        draw_point(screen, (0, 255, 255, 255), convert_coord(2,0), 5, axis_labels_font, "c", 10)

        draw_point(screen, (0, 255, 0, 255), convert_coord(2 - math.sqrt(2),0), 5, axis_labels_font, "p'", 10)
