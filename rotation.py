...
def main():
    ...
    while (True):
        ...
        draw_vector(screen, (0, 255, 255, 255), convert_coord(0,0), convert_coord(1,1), 2, vector_labels_font, "v", 24) 

        draw_vector(screen, (255, 255, 0, 255), convert_coord(0,0), convert_coord(0,math.sqrt(2)), 2, vector_labels_font, "v'", 24) 

        x,y = convert_coord(0,0)
        
        pygame.draw.arc(screen, (255, 0, 255, 255), [x-50, y - 50, 100, 100], math.radians(45), math.radians(90), 2)
