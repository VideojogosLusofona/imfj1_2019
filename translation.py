...
def main():
    ...
    while (True):
        ...
        draw_point(screen, (255, 255, 0, 255), convert_coord(1,1), 5, axis_labels_font, "p", 10)

        draw_vector(screen, (0, 255, 255, 255), convert_coord(1,1), convert_coord(2,0), 2, vector_labels_font, "t", 24) 

        draw_point(screen, (255, 255, 0, 255), convert_coord(2,0), 5, axis_labels_font, "p'", 10)
